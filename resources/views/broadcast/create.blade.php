  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/broadcast" method="post">
          {{csrf_field()}}
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Target Market" name="target">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Jenis Kartu" name="jenis_kartu">
            </div>
          </div>
          <!-- /.box-body -->
