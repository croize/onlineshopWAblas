...
<head>
  ...
  <link rel="stylesheet" href="{{url('assetdashboard/dist/css/skins/_all-skins.min.css')}}">
  @yield('css')
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{url('assetdashboard/dist/img/Mobster Logo Fix-02.png')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{Auth::user()->name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{url('assetdashboard/dist/img/Mobster Logo Fix-02.png')}}" class="img-circle" alt="User Image">

                <p>
                  {{Auth::user()->name}} - @if(Auth::user()->level == "0") Head Admin @elseif(Auth::user()->level == "1") Operator @elseif(Auth::user()->level == "2") Mitra @elseif(Auth::user()->level == "3") Reseller @endif
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="/admin/content">
            <i class="fa fa-file-archive-o"></i> <span>Content</span>
          </a>
        </li>
        <li>
          <a href="/admin/barang">
            <i class="fa fa-tags"></i> <span>Barang</span>
          </a>
        </li>
        <li>
...
<!-- jQuery 3 -->
<script src="{{url('assetdashboard/bower_components/jquery/dist/jquery.min.js')}}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{url('assetdashboard/bower_components/bootstrap/dist/js/bootstrap.min.js')}}"></script>
<!-- SlimScroll -->
<script src="{{url('assetdashboard/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
<!-- FastClick -->
<script src="{{url('assetdashboard/bower_components/fastclick/lib/fastclick.js')}}"></script>
<!-- AdminLTE App -->
<script src="{{url('assetdashboard/dist/js/adminlte.min.js')}}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{url('assetdashboard/dist/js/demo.js')}}"></script>
@yield('js')
<script>
