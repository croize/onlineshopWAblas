...
<br>
<form action="">
<button type="button" style="background: transparent;color: black;padding: 10px 40px;border: 2px solid black;" class="btn btn-default btn-lg" onclick=" window.open('http://bit.ly/formatpembelianfix','_blank')">Beli Sekarang</button>
</form>
</div>
